...
public class GetAllUserStepDefinition {
    ...
    public void send_request_get_list_user() {
        SerenityRest.when().get(GetUserApi.GET_LIST_USER);
    }
    ...
    public void getListUserJsonSchemaValidator() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserJsonSchemaValidator.json");
    ...
    public void getAllListUserWithParam(String param) {
        get.getListAllUser(param);
    }
    @When("Send request get all user")
    public void sendRequestGetAllUser() {
        SerenityRest.when().get(GetUserApi.GET_ALL_USER);
    }
    @And("Get list all user with json schema validator")
    public void getListAllUserWithJsonSchemaValidator() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListAllUserJsonSchemaValidator.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void getListUserWithoutPageQueryJsonSchema() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserWithoutPageQueryJsonSchema.json");
    }
    ...
    public void getListUserWithNonExistPageJsonSchema() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserNonExistPageJsonSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void getListUserWithInvalidPageJsonSchema() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserInvalidPageJsonSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void getListUserWithWrongPageQueryTitleOnPagePage(int page) {
        get.getListUserWrongSequence(page);
    }
    @When("Send request with wrong page title")
    public void sendRequestWithWrongPageTitle() {
        SerenityRest.when().get(GetUserApi.GET_ALL_USER_WRONG_PAGE_TITLE);
    }
    @And("Get list user with wrong title page json schema")
    public void getListUserWithWrongTitlePageJsonSchema() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserWrongPageTitleParameter.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void sendRequestWithoutQuestionMark() {
        SerenityRest.when().get(GetUserApi.GET_ALL_USER_WITHOUT_QUEST_MARK);
    }

    @And("Get list user without question mark json schema")
    public void getListUserWithoutQuestionMarkJsonSchema() {
        File json = new File(GetUserApi.JSON_FILE+"/SchemaValidator/GetListUserWithoutQuestionMarkJsonSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
}
